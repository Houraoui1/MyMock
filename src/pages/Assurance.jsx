...
const Assurance = () => {
  ...
  return (
    ...
    >
      ...
      >
        <h1 style={{ fontFamily: "cursive", marginLeft: "10%" }}>
          meilleur mutuelle
        </h1>
        <hr />
      </div>
        ...
        >
          ...
          >
            ...
            <Grid item xs={12} lg={6}>
              <Item>
                <img
                  src="https://www.malakoffhumanis.com/sites/smile/files/styles/media_full_width/public/images/malakoffhumanis-2023-181-illustration-comparateur-mutuelle-AS573455283-1024x577.png?itok=8i-h-aab"
                  style={{
                    width: "70%",
                    height: "60%",
                  }}
